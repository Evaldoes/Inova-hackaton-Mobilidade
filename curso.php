    ...
    <div row col-md-8>
      ...
      <hr>
        <section class="formulario">
          ...
          Escola<br>
          <input type="text" name="escola" class="campo" maxlength="45" required autofocus placeholder="Informe o nome da escola"><br><br>
          
          Módulo<br>
          <input type="text" name="modulo" class="campo" maxlength="45" required placeholder="Informe o seu e-mail"><br><br>

          Turno (1-Matutio, 2-Vespertino, 3-Noturno)<br>
          <input type="text" name="turno" class="campo" maxlength="20" required placeholder="Número."><br><br>
